...
function Feautres() {
  return (
    <div>
    <div className="grid grid-cols-12 gap-x-5 pb-3 text-base">
      ...
      <div className="col-span-12 md:col-span-6 lg:col-span-3 pb-1">
        <div className="flex items-center border mb-4 p-6">
          <FontAwesomeIcon icon={faShippingFast} className="text-primary mr-2" />
      ...
      <div className="col-span-12 md:col-span-6 lg:col-span-3 pb-1">
        <div className="flex items-center border mb-4 p-6">
          <FontAwesomeIcon icon={faExchangeAlt} className="text-primary mr-3" />
      ...
      <div className="col-span-12 md:col-span-6 lg:col-span-3 pb-1">
        <div className="flex items-center border mb-4 p-6">
          <FontAwesomeIcon icon={faPhoneVolume} className="text-primary mr-3" />
